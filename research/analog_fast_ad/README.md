...
The [V30 article](../../paper/pandrosion_analog_v30/Pandrosion_Geometry_Analog_V30.pdf) presents the geometry, centered arithmetic, Lean scope, calibration, validation and precision–time results in eleven pages.
