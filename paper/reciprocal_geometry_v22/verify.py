"""Reproduce V22 mathematics and figures; Lean and SPICE run in separate CI jobs."""
...
print('PASS: V22 mathematics, two controllers, five Pandrosion figures and companion provenance')
