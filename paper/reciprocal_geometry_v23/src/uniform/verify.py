"""V23: independent checks of the uniform written proof and exact formula comparisons.
...
report={'scope':'Symbolic identities and finite checks of written V23 results; not a new Lean theorem',
