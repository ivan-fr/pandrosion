...
A eleven-page English research preprint on the centered binary-power AD prototype.
...
The electrical schematic is generated by `draw_circuit.py` from the SPICE topology; it distinguishes behavioral sources, physical RC/switch primitives and omitted implementation details. Basic node pairs and values are checked against a generated deck.
