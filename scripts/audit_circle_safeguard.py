"""Independent circle-safeguard axiom audit, without changing the frozen V20 audit."""
import re
import subprocess
from pathlib import Path
source = Path('validation/rectangle_circle_safeguard/Audit.lean')
...
print(f'Circle safeguard: {len(records)} declarations passed the axiom audit.')
